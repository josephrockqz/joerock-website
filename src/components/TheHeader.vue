  ...
  <div>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-title class="headline">
        ...
        <span class="green--text">Rock</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        <v-btn flat to="/" active-class="green--text headline">LANDING</v-btn>
        <v-btn flat to="/resume" active-class="green--text headline">RESUME</v-btn>
        <v-btn flat to="/games" active-class="green--text headline">GAMES</v-btn>
